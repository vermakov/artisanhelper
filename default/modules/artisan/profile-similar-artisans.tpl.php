...
<?php foreach($similar_artisans as $item) { ?>
  <?php print '<li class="similar_artisans_cell"><div class="profile_item_title"><a href="/artisan/' . $item['artisan_id'] . '">'. $item['name'] . '</div><div class="similar_artisans_pic"><img src="' . image_style_url('similar_artisan_pic', $item['image_url']) . '"></div></a></li>'; ?>
<?php } ?>
</ul>
</div>
</div>
